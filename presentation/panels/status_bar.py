...
class StatusBar(QObject):
    ...
    def set_connection_status(self, status: str, color: str = "black"):
    ...
    def set_indeterminate_progress(self, indeterminate: bool = True):
    ...
    def add_permanent_widget(self, widget, stretch: int = 0):
    ...
    def set_status_tip(self, widget, tip: str):
        """Set the status tip for a widget."""
        if widget:
            widget.setStatusTip(tip)
    
    def set_tool_tip(self, widget, tip: str):
